...
function EventSource(Sender) {
    return class extends Sender {
        ...
        addEventListener(event, eventHandler, options) {
            ...
            if (h.options.includes?.every((f) => (0, lodash_1.isEmpty)(f))) {
            ...
            if (!Object.keys(handlers).some((id) => (0, lodash_1.isEqual)(handlers[id], h))) {
        ...
        removeEventListener(event, eventHandler, options) {
            ...
            const handlerId = Object.keys(handlers).find((id) => (0, lodash_1.isEqual)(handlers[id], h));
            if (handlerId) {
