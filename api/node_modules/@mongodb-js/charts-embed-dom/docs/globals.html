...
<head>
	...
	<title>@mongodb-js/charts-embed-dom | @mongodb-js/charts-embed-dom</title>
		...
		<div class="container">
			<div class="table-wrap">
				<div class="table-cell">
					<strong><a href="index.html">@mongodb-js/charts-embed-dom</a></strong>
				</div>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-class">
			<a href="classes/chart.html" class="tsd-kind-icon">Chart</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/dashboard.html" class="tsd-kind-icon">Dashboard</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/embedsdk.html" class="tsd-kind-icon">EmbedSDK</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/embedchartoptions.html" class="tsd-kind-icon">Embed<wbr>Chart<wbr>Options</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/embeddashboardoptions.html" class="tsd-kind-icon">Embed<wbr>Dashboard<wbr>Options</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/sharedembedoptions.html" class="tsd-kind-icon">Shared<wbr>Embed<wbr>Options</a>
		</li>
		<li class=" tsd-kind-type-alias">
			<a href="globals.html#renderingspec" class="tsd-kind-icon">Rendering<wbr>Spec</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#getrealmusertoken" class="tsd-kind-icon">get<wbr>Realm<wbr>User<wbr>Token</a>
		</li>
	</ul>
</nav>
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			...
			<div align="center">
				<p>Programmatically <strong>embed</strong> and <strong>control</strong> MongoDB Charts in your application.</p>
				<p><a href="https://www.npmjs.com/package/@mongodb-js/charts-embed-dom/"><img src="https://img.shields.io/npm/v/@mongodb-js/charts-embed-dom.svg" alt="npm"></a>
				<a href="https://www.npmjs.com/package/@mongodb-js/charts-embed-dom/"><img src="https://img.shields.io/npm/l/@mongodb-js/charts-embed-dom.svg" alt="npm"></a></p>
				<div style="max-width:600px;width:100%">
					<p><img src="https://user-images.githubusercontent.com/19422770/79284750-efe86800-7efe-11ea-9ed0-9813e1a0b6d6.gif" alt="demo of embedding">
					<a href="https://codesandbox.io/s/github/mongodb-js/charts-embed-sdk/tree/master/examples/charts/unauthenticated">Explore this example yourself!</a></p>
				</div>
			</div>
			<a href="#example-usage" id="example-usage" style="color: inherit; text-decoration: none;">
				<h2>Example Usage</h2>
			</a>
			<pre><code class="language-js"><span class="hljs-keyword">import</span> ChartsEmbedSDK <span class="hljs-keyword">from</span> <span class="hljs-string">'@mongodb-js/charts-embed-dom'</span>;

<span class="hljs-keyword">const</span> sdk = <span class="hljs-keyword">new</span> ChartsEmbedSDK({
  <span class="hljs-attr">baseUrl</span>: <span class="hljs-string">'https://charts.mongodb.com/charts-charts-fixture-tenant-zdvkh'</span>,
});

<span class="hljs-comment">// embed a chart</span>
<span class="hljs-keyword">const</span> chart = sdk.createChart({
  <span class="hljs-attr">chartId</span>: <span class="hljs-string">'48043c78-f1d9-42ab-a2e1-f2d3c088f864'</span>,
});

<span class="hljs-comment">// render the chart into a container</span>
chart
  .render(<span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">'chart'</span>))
  .catch(<span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> <span class="hljs-built_in">window</span>.alert(<span class="hljs-string">'Chart failed to initialise'</span>));

<span class="hljs-comment">// refresh the chart whenever #refreshButton is clicked</span>
<span class="hljs-built_in">document</span>
  .getElementById(<span class="hljs-string">'refreshButton'</span>)
  .addEventListener(<span class="hljs-string">'click'</span>, () =&gt; chart.refresh());

<span class="hljs-comment">// embed a dashboard</span>
<span class="hljs-keyword">const</span> dashboard = sdk.createDashboard({
  <span class="hljs-attr">dashboardId</span>: <span class="hljs-string">'61d02578-6148-4c87-9cad-1fbaef50a0d3'</span>,
});

<span class="hljs-comment">// render the chart into a container</span>
dashboard
  .render(<span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">'dashboard'</span>))
  .catch(<span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> <span class="hljs-built_in">window</span>.alert(<span class="hljs-string">'Dashboard failed to initialise'</span>));</code></pre>
			...
			<p><a href="https://unpkg.com/@mongodb-js/charts-embed-dom/dist/"><img src="https://img.shields.io/badge/module%20formats-umd%2c%20cjs%2c%20esm-green.svg?style=flat" alt="module formats: umd, cjs, and esm"></a></p>
			<ol>
				<li>Install the <code>@mongodb-js/charts-embed-dom</code> package</li>
			</ol>
...
npm install @mongodb-js/charts-embed-dom --save</code></pre>
			<ol start="2">
				<li>Use the package</li>
			</ol>
			<pre><code class="language-js"><span class="hljs-keyword">import</span> ChartsEmbedSDK <span class="hljs-keyword">from</span> <span class="hljs-string">'@mongodb-js/charts-embed-dom'</span>;</code></pre>
			<ol start="3">
				<li>Profit 📈</li>
			</ol>
			<a href="#distribution-bundle" id="distribution-bundle" style="color: inherit; text-decoration: none;">
				<h3>Distribution Bundle</h3>
			</a>
			<p>A <a href="https://github.com/umdjs/umd">universal module definition</a> bundle is also published on npm under the /dist folder for consumption.</p>
			<p>You can use the UMD to run <code>@mongodb-js/charts-embed-sdk</code> directly in the browser.</p>
			<pre><code class="language-html"><span class="hljs-comment">&lt;!-- library  --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/@mongodb-js/charts-embed-dom"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">script</span>&gt;</span><span class="javascript">
  <span class="hljs-keyword">const</span> ChartsEmbedSDK = <span class="hljs-built_in">window</span>.ChartsEmbedSDK;

  <span class="hljs-keyword">const</span> sdk = <span class="hljs-keyword">new</span> ChartsEmbedSDK({ ... });
  <span class="hljs-keyword">const</span> chart = sdk.createChart({ ... });

  chart.render(<span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">'chart'</span>));
</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></code></pre>
			<a href="#faqs" id="faqs" style="color: inherit; text-decoration: none;">
				<h2>FAQs</h2>
			</a>
			<a href="#i39m-using-rollup-what-configuration-options-do-i-need-to-set" id="i39m-using-rollup-what-configuration-options-do-i-need-to-set" style="color: inherit; text-decoration: none;">
				<h3>I&#39;m using Rollup, what configuration options do I need to set?</h3>
			</a>
			<p>To use the Embedding SDK with Rollup, you&#39;ll need to have a <code>rollup.config.js</code> that looks like:</p>
			<pre><code>import resolve <span class="hljs-keyword">from</span> <span class="hljs-string">'@rollup/plugin-node-resolve'</span>;
import cjs <span class="hljs-keyword">from</span> <span class="hljs-string">'@rollup/plugin-commonjs'</span>;

<span class="hljs-builtin-name">export</span><span class="hljs-built_in"> default </span>{
  input: <span class="hljs-string">'index.js'</span>,
  output: {
    file: <span class="hljs-string">'bundle.js'</span>,
    format: <span class="hljs-string">'cjs'</span>
  },
  plugins: [ cjs(), resolve({ browser: <span class="hljs-literal">true</span>, preferBuiltins: <span class="hljs-literal">false</span> }) ]
};</code></pre>
			<a href="#api" id="api" style="color: inherit; text-decoration: none;">
				<h2>API</h2>
			</a>
			<hr>
			<a href="#chartsembedsdk" id="chartsembedsdk" style="color: inherit; text-decoration: none;">
				<h3>ChartsEmbedSDK</h3>
			</a>
			<p>The default export of <code>@mongodb-js/charts-embed-dom</code>.</p>
			<a href="#constructoroptions-embedoptions-chartsembedsdk" id="constructoroptions-embedoptions-chartsembedsdk" style="color: inherit; text-decoration: none;">
				<h4><code>constructor(options: EmbedOptions): ChartsEmbedSDK</code></h4>
			</a>
			<p>Creates an SDK object that can create Chart/Dashboard instances. Accepts an <code>object</code> that contains any default options to set for all Charts/Dashboards created using this SDK instance.</p>
			<a href="#createchartoptions-embedchartoptions-chart" id="createchartoptions-embedchartoptions-chart" style="color: inherit; text-decoration: none;">
				<h4><code>createChart(options: EmbedChartOptions): Chart</code></h4>
			</a>
			<p>Creates an instance of a Chart that can be used to embed and control the MongoDB Chart specified by <code>chartId</code>.</p>
			<a href="#createdashboardoptions-embeddashboardoptions-dashboard" id="createdashboardoptions-embeddashboardoptions-dashboard" style="color: inherit; text-decoration: none;">
				<h4><code>createDashboard(options: EmbedDashboardOptions): Dashboard</code></h4>
			</a>
			<p>Creates an instance of a Dashboard that can be used to embed and control the embedded dashboard specified by <code>dashboardId</code>.</p>
			<hr>
			<a href="#embedchartoptions" id="embedchartoptions" style="color: inherit; text-decoration: none;">
				<h3>EmbedChartOptions</h3>
			</a>
			<p>These options configure the behaviour of a Chart when it is first embedded. After this, you can control the configuration of the Chart by calling methods on its handle.</p>
			<table>
				<thead>
					<tr>
						<th>name</th>
				...
				<tbody><tr>
						<td>baseUrl</td>
						<td>string</td>
						<td>The base url for your MongoDB Charts instance, it should look something like: <code>https://charts.mongodb.com/charts-example-url-zdvkh</code>.</td>
					</tr>
					<tr>
						<td>chartId</td>
						<td>string</td>
						<td>The chart id for the embedded chart. This can be found in the <code>Embed Chart</code> dialog when viewing a chart on a Dashboard.</td>
					</tr>
					<tr>
						<td>width</td>
						<td>string | number</td>
						<td>The width of the embedded chart. If no width is provided, it will default to stretching to the width of its container. If a value is provided without units, it will be assumed to be pixels (px).</td>
					</tr>
					<tr>
						<td>height</td>
						<td>string | number</td>
						<td>The height of the embedded chart. If no height is provided, it will default to stretching to the height of its container. If a value is provided without units, it will be assumed to be pixels (px).</td>
					</tr>
					<tr>
						<td>autoRefresh</td>
						<td>boolean</td>
						<td>Specifies whether the chart automatically refreshes. If omitted, charts automatically refresh. Use this option with the maxDataAge option to configure how often the chart refreshes.</td>
					</tr>
					<tr>
						<td>maxDataAge</td>
						<td>number</td>
						<td>Specifies the maximum age of data to load from the cache when loading or refreshing the chart. If omitted, MongoDB Charts renders the chart with data from the cache if the data is less than one hour old.</td>
					</tr>
					<tr>
						<td>background</td>
						<td>string</td>
						<td>A <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/background-color">background color</a> for the embedded chart e.g. &#39;transparent&#39;. If no background is provided it will set a default based on the theme.</td>
					</tr>
					<tr>
						<td>filter</td>
						<td>object</td>
						<td>A filter to apply to the embedded chart. This expects an object that contains valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed fields list in the &#39;Embed Chart&#39; dialog for each Chart you wish to filter on.</td>
					</tr>
					<tr>
						<td>preFilter</td>
						<td>object</td>
						<td>A filter to apply to the embedded chart. This filter is applied before the Chart query stage, see <a href="https://www.mongodb.com/docs/charts/aggregation-pipeline-generation/#backing-aggregation-pipeline">backing aggregation pipeline</a>. This expects an object that contains valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed fields list in the &#39;Embed Chart&#39; dialog for each Chart you wish to filter on.</td>
					</tr>
					<tr>
						<td>getUserToken</td>
						<td>function</td>
						<td>A function that should return a valid JWT token to use for authenticating the render request.</td>
					</tr>
					<tr>
						<td>theme</td>
						<td>&#39;light&#39; | &#39;dark&#39;</td>
						<td>The color scheme to apply to the chart. Defaults to <code>light</code>. If the theme is set to &#39;dark&#39;, you will need to ensure that your background color has appropriate contrast as by default a chart&#39;s background is transparent.</td>
					</tr>
					<tr>
						<td>showAttribution</td>
						<td>boolean</td>
						<td>Whether to show the MongoDB attribution logo on the embedded chart. By default, this is set to <code>true</code>.</td>
					</tr>
					<tr>
						<td>renderingSpec</td>
						<td>object</td>
						<td>A rendering specification to apply customizations that the embedded chart supports. See the <a href="https://github.com/mongodb-js/charts-embed-sdk/tree/master/docs/rendering-spec.md">rendering specification</a> for details on what are the supported customizations and the format of this object.</td>
					</tr>
			</tbody></table>
			<hr>
			<a href="#embeddashboardoptions" id="embeddashboardoptions" style="color: inherit; text-decoration: none;">
				<h3>EmbedDashboardOptions</h3>
			</a>
			<p>These options configure the behaviour of a Dashboard when it is first embedded. After this, you can control the configuration of the Dashboard by calling methods on its handle.</p>
			<table>
				<thead>
					<tr>
						<th>name</th>
				...
				<tbody><tr>
					...
					<tr>
						<td>dashboardId</td>
						<td>string</td>
						<td>The dashboard id for the embedded dashboard. This can be found in the <code>Embed Dashboard</code> dialog.</td>
					</tr>
					<tr>
						<td>width</td>
						<td>string | number</td>
						<td>The width of the embedded dashboard. If no width is provided, it will default to stretching to the width of its container. If a value is provided without units, it will be assumed to be pixels (px).</td>
					</tr>
					<tr>
						<td>height</td>
						<td>string | number</td>
						<td>The height of the embedded dashboard. If no height is provided, it will default to stretching to the height of its container. If a value is provided without units, it will be assumed to be pixels (px).</td>
					</tr>
					<tr>
						<td>autoRefresh</td>
						<td>boolean</td>
						<td>Specifies whether the dashboard automatically refreshes. If omitted, dashboards automatically refresh. Use this option with the maxDataAge option to configure how often the dashboard refreshes.</td>
					</tr>
					<tr>
						<td>maxDataAge</td>
						<td>number</td>
						<td>Specifies the maximum age of data to load from the cache when loading or refreshing the dashboard. If omitted, MongoDB Charts renders the dashboard with data from the cache if the data is less than one hour old.</td>
					</tr>
					<tr>
						<td>background</td>
						<td>string</td>
						<td>A <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/background-color">background color</a> for the embedded dashboard e.g. &#39;transparent&#39;. If no background is provided it will set a default based on the theme.</td>
					</tr>
					<tr>
						<td>chartsBackground</td>
						<td>string</td>
						<td>A <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/background-color">background color</a> for all charts in the embedded dashboard e.g. &#39;transparent&#39;.</td>
					</tr>
					<tr>
						<td>getUserToken</td>
						<td>function</td>
					...
					<tr>
						<td>theme</td>
						<td>&#39;light&#39; | &#39;dark&#39;</td>
						<td>The color scheme to apply to the dashboard. Defaults to <code>light</code>.</td>
					</tr>
					<tr>
						<td>showAttribution</td>
						<td>boolean</td>
						<td>Whether to show the MongoDB attribution logo on the embedded dashboard. By default, this is set to <code>true</code>.</td>
					</tr>
					<tr>
						<td>widthMode</td>
						<td>&#39;fixed&#39; | &#39;scale&#39;</td>
						<td>Width behaviour of charts in an embedded dashboard. <code>fixed</code>: width of charts will remain the same as the configured on dashboard; <code>scale</code>: width of charts will scale according to the container. Defaults to <code>fixed</code>.</td>
					</tr>
					<tr>
						<td>heightMode</td>
						<td>&#39;fixed&#39; | &#39;scale&#39;</td>
						<td>Height behaviour of charts in an embedded dashboard. <code>fixed</code>: height of charts will remain the same as the configured on dashboard; <code>scale</code>: height of charts will scale according to the container. Defaults to <code>fixed</code>.</td>
					</tr>
					<tr>
						<td>showTitleAndDesc</td>
						<td>boolean</td>
						<td>Whether to show the dashboard title and description on the embedded dashboard. By default, this is set to <code>false</code> .</td>
					</tr>
					<tr>
						<td>filter</td>
						<td>object</td>
						<td>A filter to apply to all charts in the embedded dashboard. This expects an object that contains valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed fields list for filtering in the &#39;Embed Dashboard&#39; dialog.</td>
					</tr>
					<tr>
						<td>preFilter</td>
						<td>object</td>
						<td>A filter to apply to all charts in the embedded dashboard. This filter is applied before chart query, see <a href="https://www.mongodb.com/docs/charts/aggregation-pipeline-generation/#backing-aggregation-pipeline">backing aggregation pipeline</a>. This expects an object that contains valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed fields list for filtering in the &#39;Embed Dashboard&#39; dialog.</td>
					</tr>
					<tr>
						<td>charts</td>
						<td>array of objects</td>
						<td>Embedding options to apply to specified embedded dashboard charts. Currently, we only support filters and preFilters. An example is <code>[ { chartId: &#39;0b1e7577-5ad6-4be4-8b13-5b0bee7d291f&#39;, preFilter: { price: { $gt: 100 }}, filter: { city: &#39;Sydney&#39; }}]</code> where chartId is the embedding chart id of the dashboard chart, and filter is an MQL expression for what you want to filter this chart&#39;s data by.</td>
					</tr>
			</tbody></table>
			<hr>
			<a href="#chart" id="chart" style="color: inherit; text-decoration: none;">
				<h3>Chart</h3>
			</a>
			<p>The Chart instance returned by <code>ChartsEmbedSDK.createChart({ ... })</code>.</p>
			<a href="#rendercontainer-htmlelement-promiseltvoidgt" id="rendercontainer-htmlelement-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>render(container: HTMLElement): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Renders a chart into the specified container and should only be invoked once. It returns a Promise that will resolve once the chart is &#39;ready&#39; to accept commands (like <code>setFilter</code>, <code>refresh</code>).</p>
			<a href="#refresh-promiseltvoidgt" id="refresh-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>refresh(): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Triggers a refresh of the chart, if it is embedded.</p>
			<a href="#setautorefreshbool-boolean-promiseltvoidgt" id="setautorefreshbool-boolean-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setAutoRefresh(bool: boolean): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Enable or disable chart auto refresh. Auto refresh is enabled by default.</p>
			<a href="#isautorefresh-promiseltbooleangt" id="isautorefresh-promiseltbooleangt" style="color: inherit; text-decoration: none;">
				<h4><code>isAutoRefresh(): Promise&lt;boolean&gt;</code></h4>
			</a>
			<p>Returns whether auto refreshing is enabled or not.</p>
			<a href="#setmaxdataageseconds-number-promiseltvoidgt" id="setmaxdataageseconds-number-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setMaxDataAge(seconds: number): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Sets a duration (in seconds) for how old a chart is allowed to be before it is considered expired.</p>
			<a href="#getmaxdataage-promiseltnumbergt" id="getmaxdataage-promiseltnumbergt" style="color: inherit; text-decoration: none;">
				<h4><code>getMaxDataAge(): Promise&lt;number&gt;</code></h4>
			</a>
			<p>Returns the duration (in seconds) that has to pass before a chart is considered stale.</p>
			<a href="#setfilterfilter-object-promiseltvoidgt" id="setfilterfilter-object-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setFilter(filter: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Applies a filter to the embedded chart. This expects an object that contains valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed list in the &#39;Embed Chart&#39; dialog. An empty document <code>{}</code> is equivalent to no filter.</p>
			<a href="#getfilter-promiseltobjectgt" id="getfilter-promiseltobjectgt" style="color: inherit; text-decoration: none;">
				<h4><code>getFilter(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the current filter applied to the embedded chart.</p>
			<a href="#setprefilterfilter-object-promiseltvoidgt" id="setprefilterfilter-object-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setPreFilter(filter: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Applies a preliminary filter to the embedded chart. This filter is applied before the Chart query stage, see <a href="https://www.mongodb.com/docs/charts/aggregation-pipeline-generation/#backing-aggregation-pipeline">backing aggregation pipeline</a>. This expects an object that contains valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this <code>preFilter</code> are expected to be added to the allowed list in the &#39;Embed Chart&#39; dialog. An empty document <code>{}</code> is equivalent to no PreFilter.</p>
			<a href="#getprefilter-promiseltobjectgt" id="getprefilter-promiseltobjectgt" style="color: inherit; text-decoration: none;">
				<h4><code>getPreFilter(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the current <code>preFilter</code> applied to the embedded chart.</p>
			<a href="#setthemetheme-39dark39--39light39-promiseltvoidgt" id="setthemetheme-39dark39--39light39-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setTheme(theme: &#39;dark&#39; | &#39;light&#39;): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Sets the current theme of the embedded chart. When setting the theme to &#39;dark&#39;, you will need to ensure that your background color has appropriate contrast as by default a chart&#39;s background is transparent.</p>
			<a href="#gettheme-promiseltstringgt" id="gettheme-promiseltstringgt" style="color: inherit; text-decoration: none;">
				<h4><code>getTheme(): Promise&lt;string&gt;</code></h4>
			</a>
			<p>Returns the current theme applied to the embedded chart.</p>
			<a href="#addeventlistenerevent-string-eventhandler-payload-object-gt-void-options-object-promiseltvoidgt" id="addeventlistenerevent-string-eventhandler-payload-object-gt-void-options-object-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>addEventListener(event: string, eventHandler: (payload: object) =&gt; void, options: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Adds an event listener to an embedded chart. We currently support only &#39;click&#39; events. The <code>payload</code> parameter in the event callback contains details on the chart element clicked. You can also define the chart&#39;s mark roles and/or types for which you want to receive event information in the <code>options</code> parameter. More information regarding how to handle click events can be found in the <a href="https://www.mongodb.com/docs/charts/handle-click-events/">Charts documentation</a>.</p>
			<a href="#removeeventlistenerevent-string-eventhandler-payload-object-gt-void-options-object-promiseltvoidgt" id="removeeventlistenerevent-string-eventhandler-payload-object-gt-void-options-object-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>removeEventListener(event: string, eventHandler: (payload: object) =&gt; void, options: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Removes an event listener that was previously added. You need to provide the same parameters that were used for subscribing to the event.</p>
			<a href="#sethighlightvalue-object-promiseltvoidgt" id="sethighlightvalue-object-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setHighlight(value: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Sets a highlight to apply to an embedded chart. The <code>value</code> object parameter should contain valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. It is the same type of object that can be used in <code>setFilter</code>. However, it <a href="https://www.mongodb.com/docs/charts/filter-embedded-charts/#filter-syntax">doesn&#39;t support some query expressions</a> and there are some specifics about what is <a href="https://www.mongodb.com/docs/charts/highlight-chart-elements/">highlightable</a>.
			You can clear an existing highlight by setting the <code>value</code> to an empty object <code>{}</code>. More information regarding charts highlighting can be found in the <a href="https://www.mongodb.com/docs/charts/handle-click-events/">Charts documentation</a>.</p>
			<a href="#gethighlight-promiseltobjectgt" id="gethighlight-promiseltobjectgt" style="color: inherit; text-decoration: none;">
				<h4><code>getHighlight(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the current highlight applied to an embedded chart.</p>
			<a href="#getdata-promiseltobjectgt" id="getdata-promiseltobjectgt" style="color: inherit; text-decoration: none;">
				<h4><code>getData(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the underlying data used to render chart. It has the following structure</p>
			<pre><code>{
  <span class="hljs-comment">// an object whose key is the name of a channel, e.g. x, y, etc</span>
<span class="hljs-symbol">  fields:</span> { [channel]: string },
  <span class="hljs-comment">// an array of object whose key is the name of a channel, e.g. x, y, etc</span>
<span class="hljs-symbol">  documents:</span> Array<span class="hljs-params">&lt;{ [channel]: any }&gt;</span>
}</code></pre>
			<a href="#getimageoption--encoding-39base6439--39binary39--promiseltstringblobgt" id="getimageoption--encoding-39base6439--39binary39--promiseltstringblobgt" style="color: inherit; text-decoration: none;">
				<h4><code>getImage(option: { encoding: &#39;base64&#39; | &#39;binary&#39; }): Promise&lt;string|Blob&gt;</code></h4>
			</a>
			<p>Returns a PNG image of the embedded chart in the required encoding, i.e. &#39;base64&#39; or &#39;binary&#39;. Note that <code>Table Chart</code> is not supported.</p>
			<a href="#setrenderingspecoverridevalue-object-promiseltvoidgt" id="setrenderingspecoverridevalue-object-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setRenderingSpecOverride(value: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Sets a customization on the embedded chart. See the <a href="https://github.com/mongodb-js/charts-embed-sdk/tree/master/docs/rendering-spec.md">rendering specification</a> for details on what is customizable and the format of this object.</p>
			<a href="#getrenderingspecoverride-promiseltobjectgt--undefined" id="getrenderingspecoverride-promiseltobjectgt--undefined" style="color: inherit; text-decoration: none;">
				<h4><code>getRenderingSpecOverride(): Promise&lt;object&gt; | undefined</code></h4>
			</a>
			<p>Returns the customizations set on the embedded chart from calling setRenderingSpecOverride().</p>
			<a href="#getchannels-promiseltobjectgt" id="getchannels-promiseltobjectgt" style="color: inherit; text-decoration: none;">
				<h4><code>getChannels(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the chart channels for the embedded chart.</p>
			<a href="#getcustomizableaxes-promiseltobjectgt" id="getcustomizableaxes-promiseltobjectgt" style="color: inherit; text-decoration: none;">
				<h4><code>getCustomizableAxes(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the customizable chart axes for the embedded chart. This will return an empty object if no axes are customizable for the embedded chart.</p>
			<hr>
			<a href="#dashboard" id="dashboard" style="color: inherit; text-decoration: none;">
				<h3>Dashboard</h3>
			</a>
			<p>The Dashboard instance returned by <code>ChartsEmbedSDK.createDashboard({ ... })</code>.</p>
			<a href="#rendercontainer-htmlelement-promiseltvoidgt-1" id="rendercontainer-htmlelement-promiseltvoidgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>render(container: HTMLElement): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Renders a dashboard into the specified container and should only be invoked once. It returns a Promise that will resolve once the dashboard is &#39;ready&#39; to accept commands (like <code>refresh</code>).</p>
			<p>Note that the charts inside the embedded dashboard will render as soon as their data is fetched. Since the charts data fetch is an asynchronous process, some of the charts will render with data after the dashboard renders itself. Keep this in mind when using the dashboard charts methods.</p>
			<a href="#refresh-promiseltvoidgt-1" id="refresh-promiseltvoidgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>refresh(): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Triggers a refresh of the dashboard.</p>
			<a href="#setautorefreshvalue-boolean-promiseltvoidgt" id="setautorefreshvalue-boolean-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setAutoRefresh(value: boolean): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Enable or disable auto refresh. Auto refresh is enabled by default.</p>
			<a href="#isautorefresh-promiseltbooleangt-1" id="isautorefresh-promiseltbooleangt-1" style="color: inherit; text-decoration: none;">
				<h4><code>isAutoRefresh(): Promise&lt;boolean&gt;</code></h4>
			</a>
			<p>Returns whether auto refreshing is enabled or not.</p>
			<a href="#setmaxdataageseconds-number-promiseltvoidgt-1" id="setmaxdataageseconds-number-promiseltvoidgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>setMaxDataAge(seconds: number): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Sets a duration (in seconds) for how old a chart on a dashboard is allowed to be before it is considered expired.</p>
			<a href="#getmaxdataage-promiseltnumbergt-1" id="getmaxdataage-promiseltnumbergt-1" style="color: inherit; text-decoration: none;">
				<h4><code>getMaxDataAge(): Promise&lt;number&gt;</code></h4>
			</a>
			<p>Returns the duration (in seconds) that has to pass before a chart on a dashboard is considered stale.</p>
			<a href="#setthemetheme-39dark39--39light39-promiseltvoidgt-1" id="setthemetheme-39dark39--39light39-promiseltvoidgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>setTheme(theme: &#39;dark&#39; | &#39;light&#39;): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Sets the current theme of the embedded dashboard. Defaults to <code>&#39;light&#39;</code>;</p>
			<a href="#gettheme-promiseltstringgt-1" id="gettheme-promiseltstringgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>getTheme(): Promise&lt;string&gt;</code></h4>
			</a>
			<p>Returns the current theme applied to the embedded dashboard.</p>
			<a href="#setchartsbackgroundcolor-string-promiseltvoidgt" id="setchartsbackgroundcolor-string-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setChartsBackground(color: string): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Sets a custom background color that will be applied to all charts of the embedded dashboard.</p>
			<a href="#getchartsbackground-promiseltstringgt" id="getchartsbackground-promiseltstringgt" style="color: inherit; text-decoration: none;">
				<h4><code>getChartsBackground(): Promise&lt;string&gt;</code></h4>
			</a>
			<p>Returns the current custom background color.</p>
			<a href="#setwidthmodemode-39fixed39--39scale39-promiseltvoidgt" id="setwidthmodemode-39fixed39--39scale39-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setWidthMode(mode: &#39;fixed&#39; | &#39;scale&#39;): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Sets the width mode that will be applied to all charts of the embedded dashboard. Defaults to <code>&#39;fixed&#39;</code>;</p>
			<a href="#getwidthmode-promiselt39fixed39--39scale39gt" id="getwidthmode-promiselt39fixed39--39scale39gt" style="color: inherit; text-decoration: none;">
				<h4><code>getWidthMode(): Promise&lt;&#39;fixed&#39; | &#39;scale&#39;&gt;</code></h4>
			</a>
			<p>Returns the current width mode.</p>
			<a href="#setheightmodemode-39fixed39--39scale39-promiseltvoidgt" id="setheightmodemode-39fixed39--39scale39-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setHeightMode(mode: &#39;fixed&#39; | &#39;scale&#39;): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Sets the height mode that will be applied to all charts of the embedded dashboard. Defaults to <code>&#39;fixed&#39;</code>;</p>
			<a href="#getheightmode-promiselt39fixed39--39scale39gt" id="getheightmode-promiselt39fixed39--39scale39gt" style="color: inherit; text-decoration: none;">
				<h4><code>getHeightMode(): Promise&lt;&#39;fixed&#39; | &#39;scale&#39;&gt;</code></h4>
			</a>
			<p>Returns the current height mode.</p>
			<a href="#setshowattributionvalue-boolean-promiseltvoidgt" id="setshowattributionvalue-boolean-promiseltvoidgt" style="color: inherit; text-decoration: none;">
				<h4><code>setShowAttribution(value: boolean): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Enable or disable the attribution logo. Attribution is enabled by default.</p>
			<a href="#isshowattribution-promiseltbooleangt" id="isshowattribution-promiseltbooleangt" style="color: inherit; text-decoration: none;">
				<h4><code>isShowAttribution(): Promise&lt;boolean&gt;</code></h4>
			</a>
			<p>Returns whether the attribution logo is enabled.</p>
			<a href="#setfilterfilter-object-promiseltvoidgt-1" id="setfilterfilter-object-promiseltvoidgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>setFilter(filter: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Applies a filter to all charts in an embedded dashboard. This expects an object that contains valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed list in the &#39;Embed Dashboard&#39; dialog (or in the &#39;Embed Chart&#39; dialog for all charts in the dashboard). An empty document <code>{}</code> is equivalent to no filter. Note: the embedded dashboard filter is independent from the embedded dashboard chart filter - if you have set both of them, they will both apply on the chart.</p>
			<a href="#getfilter-promiseltobjectgt-1" id="getfilter-promiseltobjectgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>getFilter(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the current filter applied directly to the embedded dashboard.</p>
			<a href="#setprefilterfilter-object-promiseltvoidgt-1" id="setprefilterfilter-object-promiseltvoidgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>setPreFilter(filter: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Applies a preliminary filter to all charts in an embedded dashboard. This filter is applied before the Chart query stage, see <a href="https://www.mongodb.com/docs/charts/aggregation-pipeline-generation/#backing-aggregation-pipeline">backing aggregation pipeline</a>. This expects an object that contains valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this <code>preFilter</code> are expected to be added to the allowed list in the &#39;Embed Dashboard&#39; dialog (or in the &#39;Embed Chart&#39; dialog for all charts in the dashboard). An empty document <code>{}</code> is equivalent to no PreFilter. Note: the embedded dashboard <code>preFilter</code> is independent from the embedded dashboard chart <code>preFilter</code> - if you have set both of them, they will both apply on the chart.</p>
			<a href="#getprefilter-promiseltobjectgt-1" id="getprefilter-promiseltobjectgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>getPreFilter(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the current <code>preFilter</code> applied directly to the embedded dashboard.</p>
			<a href="#getchartchartid-string-promiseltdashboardchartgt" id="getchartchartid-string-promiseltdashboardchartgt" style="color: inherit; text-decoration: none;">
				<h4><code>getChart(chartId: string): Promise&lt;DashboardChart&gt;</code></h4>
			</a>
			<p>Returns an instance <code>DashboardChart</code> that has the specified chart id.</p>
			<a href="#getallcharts-promiseltdashboardchartgt" id="getallcharts-promiseltdashboardchartgt" style="color: inherit; text-decoration: none;">
				<h4><code>getAllCharts(): Promise&lt;DashboardChart[]&gt;</code></h4>
			</a>
			<p>Returns an array of <code>DashboardChart</code> instances of all charts on the embedded dashboard.</p>
			<a href="#getimageoption--encoding-39base6439--39binary39--promiseltstringblobgt-1" id="getimageoption--encoding-39base6439--39binary39--promiseltstringblobgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>getImage(option: { encoding: &#39;base64&#39; | &#39;binary&#39; }): Promise&lt;string|Blob&gt;</code></h4>
			</a>
			<p>Returns a PNG image of the embed dashboard in the required encoding, i.e. &#39;base64&#39; or &#39;binary&#39;.</p>
			<hr>
			<a href="#dashboardchart" id="dashboardchart" style="color: inherit; text-decoration: none;">
				<h3>DashboardChart</h3>
			</a>
			<p>The chart instance returned by <code>Dashboard.getChart(&#39;chartId&#39;)</code> or <code>Dashboard.getAllCharts()</code>.</p>
			<a href="#refresh-promiseltvoidgt-2" id="refresh-promiseltvoidgt-2" style="color: inherit; text-decoration: none;">
				<h4><code>refresh(): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Triggers a refresh of the chart.</p>
			<a href="#addeventlistenerevent-string-eventhandler-payload-object-gt-void-options-object-promiseltvoidgt-1" id="addeventlistenerevent-string-eventhandler-payload-object-gt-void-options-object-promiseltvoidgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>addEventListener(event: string, eventHandler: (payload: object) =&gt; void, options: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Adds an event listener to the embedded chart. We currently support only &#39;click&#39; events. The <code>payload</code> parameter in the event callback contains details on the chart element clicked. You can also define the chart&#39;s mark roles and/or types for which you want to receive event information in the <code>options</code> parameter. More information regarding how to handle click events can be found in the <a href="https://www.mongodb.com/docs/charts/handle-click-events/">Charts documentation</a>.</p>
			<a href="#removeeventlistenerevent-string-eventhandler-payload-object-gt-void-options-object-promiseltvoidgt-1" id="removeeventlistenerevent-string-eventhandler-payload-object-gt-void-options-object-promiseltvoidgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>removeEventListener(event: string, eventHandler: (payload: object) =&gt; void, options: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Removes an event listener that was previously added. You need to provide the same parameters that were used for subscribing to the event.</p>
			<a href="#setfilterfilter-object-promiseltvoidgt-2" id="setfilterfilter-object-promiseltvoidgt-2" style="color: inherit; text-decoration: none;">
				<h4><code>setFilter(filter: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Applies a filter to the embedded dashboard chart. This expects an object that contains valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed list in the &#39;Embed Chart&#39; dialog or in the &quot;Embed Dashboard&quot; dialog (in which case they will be allowed for all charts in the dashboard). An empty document <code>{}</code> is equivalent to no filter. Note: the embedded dashboard chart filter is independent from the embedded dashboard filter - if you have set both of them, they will both apply on the chart.</p>
			<a href="#getfilter-promiseltobjectgt-2" id="getfilter-promiseltobjectgt-2" style="color: inherit; text-decoration: none;">
				<h4><code>getFilter(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the current filter applied directly to the embedded dashboard chart. Note: if you have applied a filter on the embedded dashboard, it will not be returned in this dashboard chart method. To get the dashboard filter, use the getFilter() method on the dashboard entity.</p>
			<a href="#setprefilterfilter-object-promiseltvoidgt-2" id="setprefilterfilter-object-promiseltvoidgt-2" style="color: inherit; text-decoration: none;">
				<h4><code>setPreFilter(filter: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Applies a preliminary filter to the embedded dashboard chart. This filter is applied before the Chart query stage, see <a href="https://www.mongodb.com/docs/charts/aggregation-pipeline-generation/#backing-aggregation-pipeline">backing aggregation pipeline</a>. This expects an object that contains valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this <code>preFilter</code> are expected to be added to the allowed list in the &#39;Embed Chart&#39; dialog or in the &quot;Embed Dashboard&quot; dialog (in which case they will be allowed for all charts in the dashboard). An empty document <code>{}</code> is equivalent to no <code>preFilter</code>. Note: the embedded dashboard chart <code>preFilter</code> is independent from the embedded dashboard <code>preFilter</code> - if you have set both of them, they will both apply on the chart.</p>
			<a href="#getprefilter-promiseltobjectgt-2" id="getprefilter-promiseltobjectgt-2" style="color: inherit; text-decoration: none;">
				<h4><code>getPreFilter(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the current <code>preFilter</code> applied directly to the embedded dashboard chart. Note: if you have applied a <code>preFilter</code> on the embedded dashboard, it will not be returned in this dashboard chart method. To get the dashboard <code>preFilter</code>, use the getPreFilter() method on the dashboard entity.</p>
			<a href="#sethighlightvalue-object-promiseltvoidgt-1" id="sethighlightvalue-object-promiseltvoidgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>setHighlight(value: object): Promise&lt;void&gt;</code></h4>
			</a>
			<p>Sets a highlight to apply to an embedded dashboard chart. The <code>value</code> object parameter should contain valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. It is the same type of object that can be used in <code>setFilter</code>. However, it <a href="https://www.mongodb.com/docs/charts/filter-embedded-charts/#filter-syntax">doesn&#39;t support some query expressions</a> and there are some specifics about what is <a href="https://www.mongodb.com/docs/charts/highlight-chart-elements/">highlightable</a>.
			You can clear an existing highlight by setting the <code>value</code> to an empty object <code>{}</code>. More information regarding charts highlighting can be found in the <a href="https://www.mongodb.com/docs/charts/handle-click-events/">Charts documentation</a>.</p>
			<a href="#gethighlight-promiseltobjectgt-1" id="gethighlight-promiseltobjectgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>getHighlight(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the current highlight applied to an embedded dashboard chart.</p>
			<a href="#getdata-promiseltobjectgt-1" id="getdata-promiseltobjectgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>getData(): Promise&lt;object&gt;</code></h4>
			</a>
			<p>Returns the underlying data used to render dashboard chart. It has the following structure.</p>
			<pre><code>{
  <span class="hljs-comment">// an object whose key is the name of a channel, e.g. x, y, etc</span>
<span class="hljs-symbol">  fields:</span> { [channel]: string },
  <span class="hljs-comment">// an array of object whose key is the name of a channel, e.g. x, y, etc</span>
<span class="hljs-symbol">  documents:</span> Array<span class="hljs-params">&lt;{ [channel]: any }&gt;</span>
}</code></pre><p>Limitation: Unlike the <code>getData()</code> method for embedded charts, in the case for embedded dashboard charts, the <code>documents</code> might not be available directly after the dashboard render. The reason for that is the nature of the embedded dashboard, and that we render the charts inside it as soon as we fetch their data. Since the charts data fetch is an asynchronous process, the dashboard chart data might not be available for all dashboard charts directly after the dashboard <code>render()</code> method.</p>
			<hr>
			<a href="#refresh-tolerance" id="refresh-tolerance" style="color: inherit; text-decoration: none;">
				<h3>Refresh Tolerance</h3>
			</a>
			<p>Refresh tolerance refers to the maximum age of the data to load from cache. It is used to determine whether an embedded chart or dashboard needs to fetch fresh data from the server or use the cached data. This value is affected by the combination of <code>autoRefresh</code> and <code>maxDataAge</code> set to the embedded entity. Below table illustrates the different scenarios.</p>
			<table>
				<thead>
					<tr>
						<th>autoRefresh</th>
						<th>maxDataAge</th>
						<th>tolerance (secs)</th>
					</tr>
				</thead>
				<tbody><tr>
						<td>true</td>
					...
					<tr>
						<td>true</td>
						<td>-1</td>
						<td>Infinity (always use cache data)</td>
					</tr>
					<tr>
						<td>true</td>
						<td>0</td>
					...
					<tr>
						<td>true</td>
						<td><code>&gt;0</code> and <code>&lt;60</code></td>
						<td>60</td>
					</tr>
					<tr>
						<td>true</td>
						<td>&gt;=60</td>
						<td>Same value as maxDataAge</td>
					</tr>
					<tr>
						<td>false</td>
						<td>undefined | null</td>
			...
			<hr>
			<a href="#realm-web-authentication" id="realm-web-authentication" style="color: inherit; text-decoration: none;">
				<h3>Realm Web Authentication</h3>
			</a>
			<a href="#getrealmusertokenclient-stitchappclient--realmappclient-string" id="getrealmusertokenclient-stitchappclient--realmappclient-string" style="color: inherit; text-decoration: none;">
				<h4><code>getRealmUserToken(client: StitchAppClient | RealmAppClient): string</code></h4>
			</a>
			<p>A helper function to use the Atlas App Services authentication provider.
			Returns a value to pass to the <code>getUserToken</code> prop via a function.</p>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-class"><a href="classes/chart.html" class="tsd-kind-icon">Chart</a></li>
							<li class="tsd-kind-class"><a href="classes/dashboard.html" class="tsd-kind-icon">Dashboard</a></li>
							<li class="tsd-kind-class"><a href="classes/embedsdk.html" class="tsd-kind-icon">EmbedSDK</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface"><a href="interfaces/embedchartoptions.html" class="tsd-kind-icon">Embed<wbr>Chart<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/embeddashboardoptions.html" class="tsd-kind-icon">Embed<wbr>Dashboard<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/sharedembedoptions.html" class="tsd-kind-icon">Shared<wbr>Embed<wbr>Options</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Type aliases</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-type-alias"><a href="globals.html#renderingspec" class="tsd-kind-icon">Rendering<wbr>Spec</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function"><a href="globals.html#getrealmusertoken" class="tsd-kind-icon">get<wbr>Realm<wbr>User<wbr>Token</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="renderingspec" class="tsd-anchor"></a>
				<h3>Rendering<wbr>Spec</h3>
				<div class="tsd-signature tsd-kind-icon">Rendering<wbr>Spec<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">z.infer</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-symbol">typeof </span><span class="tsd-signature-type">RenderingSpecSchema</span><span class="tsd-signature-symbol">&gt;</span></div>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="getrealmusertoken" class="tsd-anchor"></a>
				<h3>get<wbr>Realm<wbr>User<wbr>Token</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Realm<wbr>User<wbr>Token<span class="tsd-signature-symbol">(</span>appClient<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">AppClient</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>A helper utility to support using <a href="https://www.mongodb.com/docs/realm/">Realm Authentication</a> with MongoDB Charts with two npm packages:</p>
							</div>
							<p>Using &quot;mongodb-stitch-browser-sdk&quot;</p>
							<pre><code class="language-js"><span class="hljs-keyword">const</span> client = Stitch.initializeDefaultAppClient(<span class="hljs-string">'&lt;your-client-app-id&gt;'</span>);
client.auth.loginWithCredential(...)

<span class="hljs-keyword">const</span> sdk = <span class="hljs-keyword">new</span> ChartsEmbedSDK({
  <span class="hljs-attr">getUserToken</span>: <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> getRealmUserToken(client)
})</code></pre>
							<p>or using &quot;realm-web&quot;</p>
							<pre><code class="language-js"><span class="hljs-keyword">const</span> client = <span class="hljs-keyword">new</span> Realm.App({<span class="hljs-attr">id</span>: <span class="hljs-string">'&lt;your-client-app-id&gt;'</span>});
client.logIn(...)
...
<span class="hljs-keyword">const</span> sdk = <span class="hljs-keyword">new</span> ChartsEmbedSDK({
  <span class="hljs-attr">getUserToken</span>: <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> getRealmUserToken(client)
						...
						<ul class="tsd-parameters">
							<li>
								<h5>appClient: <span class="tsd-signature-type">AppClient</span></h5>
							</li>
						</ul>
