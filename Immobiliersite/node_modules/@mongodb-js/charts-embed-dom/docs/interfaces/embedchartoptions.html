...
<head>
	...
	<title>EmbedChartOptions | @mongodb-js/charts-embed-dom</title>
		...
		<li class="current tsd-kind-interface">
			...
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#autorefresh" class="tsd-kind-icon">auto<wbr>Refresh</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#background" class="tsd-kind-icon">background</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#baseurl" class="tsd-kind-icon">base<wbr>Url</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="embedchartoptions.html#chartid" class="tsd-kind-icon">chart<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#filter" class="tsd-kind-icon">filter</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#getusertoken" class="tsd-kind-icon">get<wbr>User<wbr>Token</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#height" class="tsd-kind-icon">height</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#maxdataage" class="tsd-kind-icon">max<wbr>Data<wbr>Age</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#prefilter" class="tsd-kind-icon">pre<wbr>Filter</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="embedchartoptions.html#refreshinterval" class="tsd-kind-icon">refresh<wbr>Interval</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="embedchartoptions.html#renderingspec" class="tsd-kind-icon">rendering<wbr>Spec</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#showattribution" class="tsd-kind-icon">show<wbr>Attribution</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#theme" class="tsd-kind-icon">theme</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embedchartoptions.html#width" class="tsd-kind-icon">width</a>
				</li>
			</ul>
		</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>The set of options that you can use when both creating an <a href="../classes/embedsdk.html">EmbedSDK</a> object or using <a href="../classes/embedsdk.html#createchart">EmbedSDK.createChart</a>.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					...
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">EmbedChartOptions</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#autorefresh" class="tsd-kind-icon">auto<wbr>Refresh</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#background" class="tsd-kind-icon">background</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#baseurl" class="tsd-kind-icon">base<wbr>Url</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="embedchartoptions.html#chartid" class="tsd-kind-icon">chart<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#filter" class="tsd-kind-icon">filter</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#getusertoken" class="tsd-kind-icon">get<wbr>User<wbr>Token</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#height" class="tsd-kind-icon">height</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#maxdataage" class="tsd-kind-icon">max<wbr>Data<wbr>Age</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#prefilter" class="tsd-kind-icon">pre<wbr>Filter</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="embedchartoptions.html#refreshinterval" class="tsd-kind-icon">refresh<wbr>Interval</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="embedchartoptions.html#renderingspec" class="tsd-kind-icon">rendering<wbr>Spec</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#showattribution" class="tsd-kind-icon">show<wbr>Attribution</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#theme" class="tsd-kind-icon">theme</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embedchartoptions.html#width" class="tsd-kind-icon">width</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="chartid" class="tsd-anchor"></a>
				<h3>chart<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">chart<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The id for the chart you want to embed.</p>
					</div>
					<p>This can be found in the &quot;Embed Chart&quot; dialog when viewing a chart on a dashboard.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">refresh<wbr>Interval<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">number</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>How frequently a chart should refresh once it has been embedded.</p>
					</div>
					<p>The minimum refreshInterval is 10 seconds. By default, a chart will never refresh once rendered.</p>
					<dl class="tsd-comment-tags">
						<dt>deprecated</dt>
						<dd><p>This option is deprecated. Please use the autoRefresh option with the maxDataAge option to configure how often the chart refreshes.</p>
						</dd>
					</dl>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> rendering<wbr>Spec</h3>
				<div class="tsd-signature tsd-kind-icon">rendering<wbr>Spec<span class="tsd-signature-symbol">:</span> <a href="../globals.html#renderingspec" class="tsd-signature-type">RenderingSpec</a></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Customisation settings to apply to an embedded chart.
						This should contain the version of the rendering spec plus any number of valid customisation settings.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
