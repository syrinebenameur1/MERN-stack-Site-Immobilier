...
<head>
	...
	<title>EmbedDashboardOptions | @mongodb-js/charts-embed-dom</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class=" tsd-kind-interface">
			<a href="embedchartoptions.html" class="tsd-kind-icon">Embed<wbr>Chart<wbr>Options</a>
		</li>
		<li class="current tsd-kind-interface">
			<a href="embeddashboardoptions.html" class="tsd-kind-icon">Embed<wbr>Dashboard<wbr>Options</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#autorefresh" class="tsd-kind-icon">auto<wbr>Refresh</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#background" class="tsd-kind-icon">background</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#baseurl" class="tsd-kind-icon">base<wbr>Url</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="embeddashboardoptions.html#charts" class="tsd-kind-icon">charts</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="embeddashboardoptions.html#chartsbackground" class="tsd-kind-icon">charts<wbr>Background</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="embeddashboardoptions.html#dashboardid" class="tsd-kind-icon">dashboard<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#filter" class="tsd-kind-icon">filter</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#getusertoken" class="tsd-kind-icon">get<wbr>User<wbr>Token</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#height" class="tsd-kind-icon">height</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="embeddashboardoptions.html#heightmode" class="tsd-kind-icon">height<wbr>Mode</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#maxdataage" class="tsd-kind-icon">max<wbr>Data<wbr>Age</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#prefilter" class="tsd-kind-icon">pre<wbr>Filter</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#showattribution" class="tsd-kind-icon">show<wbr>Attribution</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="embeddashboardoptions.html#showtitleanddesc" class="tsd-kind-icon">show<wbr>Title<wbr>And<wbr>Desc</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#theme" class="tsd-kind-icon">theme</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="embeddashboardoptions.html#width" class="tsd-kind-icon">width</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="embeddashboardoptions.html#widthmode" class="tsd-kind-icon">width<wbr>Mode</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-interface">
			<a href="sharedembedoptions.html" class="tsd-kind-icon">Shared<wbr>Embed<wbr>Options</a>
		</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>The set of options that you can use when both creating an <a href="../classes/embedsdk.html">EmbedSDK</a> object or using <a href="../classes/embedsdk.html#createdashboard">EmbedSDK.createDashboard</a>.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<a href="sharedembedoptions.html" class="tsd-signature-type">SharedEmbedOptions</a>
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">EmbedDashboardOptions</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#autorefresh" class="tsd-kind-icon">auto<wbr>Refresh</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#background" class="tsd-kind-icon">background</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#baseurl" class="tsd-kind-icon">base<wbr>Url</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="embeddashboardoptions.html#charts" class="tsd-kind-icon">charts</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="embeddashboardoptions.html#chartsbackground" class="tsd-kind-icon">charts<wbr>Background</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="embeddashboardoptions.html#dashboardid" class="tsd-kind-icon">dashboard<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#filter" class="tsd-kind-icon">filter</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#getusertoken" class="tsd-kind-icon">get<wbr>User<wbr>Token</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#height" class="tsd-kind-icon">height</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="embeddashboardoptions.html#heightmode" class="tsd-kind-icon">height<wbr>Mode</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#maxdataage" class="tsd-kind-icon">max<wbr>Data<wbr>Age</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#prefilter" class="tsd-kind-icon">pre<wbr>Filter</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#showattribution" class="tsd-kind-icon">show<wbr>Attribution</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="embeddashboardoptions.html#showtitleanddesc" class="tsd-kind-icon">show<wbr>Title<wbr>And<wbr>Desc</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#theme" class="tsd-kind-icon">theme</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="embeddashboardoptions.html#width" class="tsd-kind-icon">width</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="embeddashboardoptions.html#widthmode" class="tsd-kind-icon">width<wbr>Mode</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				<a name="autorefresh" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> auto<wbr>Refresh</h3>
				<div class="tsd-signature tsd-kind-icon">auto<wbr>Refresh<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#autorefresh">autoRefresh</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Whether the embedded object should be automatically refreshed.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				...
				<div class="tsd-signature tsd-kind-icon">background<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#background">background</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The background color to use for the embedded object.</p>
					</div>
					<p>If no background is provided, it will set a default background color based on the theme.</p>
					<p>To control the background color using CSS and classes, set to <code>transparent</code>.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				...
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#baseurl">baseUrl</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The base url for your MongoDB <a href="../classes/embedsdk.html">EmbedSDK</a> instance.</p>
					</div>
					<p>This should look something like: <code>https://charts.mongodb.com/charts-example-url-zdvkh</code></p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="charts" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> charts</h3>
				<div class="tsd-signature tsd-kind-icon">charts<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">DashboardChartOption</span><span class="tsd-signature-symbol">&gt;</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Embedding options to be passed to the embedded charts in the dashboard</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="chartsbackground" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> charts<wbr>Background</h3>
				<div class="tsd-signature tsd-kind-icon">charts<wbr>Background<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Assign background colour for all charts in an embedded dashboard.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="dashboardid" class="tsd-anchor"></a>
				<h3>dashboard<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">dashboard<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The id for the dashboard you want to embed.</p>
					</div>
					<p>This can be found in the &quot;Embed Dashboard&quot; dialog.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				<a name="filter" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> filter</h3>
				<div class="tsd-signature tsd-kind-icon">filter<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">PlainObject</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#filter">filter</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The filter to apply to the embedded chart or dashboard.</p>
					</div>
					<p>This expects an object that contains a valid <a href="https://docs.mongodb.com/manual/reference/operator/query/#query-selectors">query operators</a>.
					Any fields referenced in this filter are expected to be allowed for filtering in the &quot;Embed Chart&quot; for each chart you wish to filter on or in the &quot;Embed Dashboard&quot; dialog if you are applying a filter on a dashboard.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				<a name="getusertoken" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> get<wbr>User<wbr>Token</h3>
				<div class="tsd-signature tsd-kind-icon">get<wbr>User<wbr>Token<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#getusertoken">getUserToken</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>A function that returns a valid JWT that will be used to authenticate the user.</p>
					</div>
					<p>This function will be called when the embedded object is first rendered, and then successively when the SDK needs to refresh an invalid token.</p>
					<p>See also <a href="../globals.html#getrealmusertoken">getRealmUserToken</a></p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				...
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#height">height</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The height of the embedded object.</p>
					</div>
					<p>If no height is provided, it will default to stretching to the height of it&#39;s container. If a value is provided without units, it will be assumed to be pixels (px).</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="heightmode" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> height<wbr>Mode</h3>
				<div class="tsd-signature tsd-kind-icon">height<wbr>Mode<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Scaling</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Height behaviour of charts in an embedded dashboard.</p>
					</div>
					<ul>
						<li><code>&#39;fixed&#39;</code> Height of charts will remain the same as the dashboard.</li>
						<li><code>&#39;scale&#39;</code> Height of charts will scale according to the container.</li>
					</ul>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				<a name="maxdataage" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> max<wbr>Data<wbr>Age</h3>
				<div class="tsd-signature tsd-kind-icon">max<wbr>Data<wbr>Age<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">number</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#maxdataage">maxDataAge</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>How long in seconds data is considered fresh.</p>
					</div>
					<p>By default, staleness tolerance is 1 hour.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				<a name="prefilter" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> pre<wbr>Filter</h3>
				<div class="tsd-signature tsd-kind-icon">pre<wbr>Filter<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">PlainObject</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#prefilter">preFilter</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The filter to apply as the first stage on the Data Source.</p>
					</div>
					<p>This expects an object that contains a valid <a href="https://docs.mongodb.com/manual/reference/operator/query/#query-selectors">query operators</a>.
					Any fields referenced in this filter are expected to be allowed for filtering in the &quot;Embed Chart&quot; for each chart you wish to filter on or in the &quot;Embed Dashboard&quot; dialog if you are applying a filter on a dashboard.</p>
					<p>If filtering is required on a dynamic field defined via a Lookup, Calculated or Query Bar, then <code>filter</code> is appropriate property to set.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				<a name="showattribution" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> show<wbr>Attribution</h3>
				<div class="tsd-signature tsd-kind-icon">show<wbr>Attribution<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#showattribution">showAttribution</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Whether to show the MongoDB attribution logo.</p>
					</div>
					<p>By default, this is set to <code>true</code></p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="showtitleanddesc" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> show<wbr>Title<wbr>And<wbr>Desc</h3>
				<div class="tsd-signature tsd-kind-icon">show<wbr>Title<wbr>And<wbr>Desc<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Display the dashboard title and description.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				...
				<div class="tsd-signature tsd-kind-icon">theme<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Theme</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#theme">theme</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The color scheme to apply.</p>
					</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				...
				<aside class="tsd-sources">
					<p>Inherited from <a href="sharedembedoptions.html">SharedEmbedOptions</a>.<a href="sharedembedoptions.html#width">width</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The width of the embedded object.</p>
					</div>
					<p>If no width is provided, it will default to stretching to the width of it&#39;s container. If a value is provided without units, it will be assumed to be pixels (px).</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="widthmode" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> width<wbr>Mode</h3>
				<div class="tsd-signature tsd-kind-icon">width<wbr>Mode<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Scaling</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Width behaviour of charts in an embedded dashboard.</p>
					</div>
					<ul>
						<li><p><code>&#39;fixed&#39;</code> Width of charts will remain the same as the dashboard.</p>
						</li>
						<li><p><code>&#39;scale&#39;</code> Width of charts will scale according to the container.</p>
						</li>
					</ul>
				</div>
			</section>
