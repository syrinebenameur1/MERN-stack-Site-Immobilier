...
const base_embed_item_1 = __importDefault(require("./base-embed-item"));
const event_source_1 = require("./mixins/event-source");
const refreshable_1 = require("./mixins/refreshable");
const common_chart_1 = require("./mixins/common-chart");
const filterable_1 = require("./mixins/filterable");
const utils_1 = require("./utils");
const getChartOptions = (options) => {
    if (typeof options !== 'object' || options === null) {
        throw new Error('Options argument must be an object');
    }
    const sharedEmbedOptions = (0, utils_1.getSharedEmbedOptions)(options);
    ...
    if (renderingSpec !== undefined && !(0, utils_1.isPlainObject)(renderingSpec)) {
...
class ChartEventSender extends base_embed_item_1.default {
    /** @ignore */
    constructor(options) {
        super();
    ...
    getEmbedUrl() {
        return (0, utils_1.getChartUrl)(this.options);
    }
}
/**
 * # Chart
